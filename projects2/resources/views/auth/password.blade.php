    ...
    <div class="container">
        ...
        <form method="POST" action="{!! action('Auth\AuthController@resetPassword', $token) !!}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="inputPassword1" name="password1" value="" class="form-control" required>
                <p class="help-block">
            ...
            <div class="form-group">
                ...
                <input type="text" id="inputPassword2" name="password2" value="" class="form-control" required>
            </div>
            <p></p>
